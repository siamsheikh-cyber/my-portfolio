function RightAbout() {
    return <>
        <div className="w-[50%] flex items-center-safe gap-5">
            ...
            <div className="w-[80%]">
                <img src="/images/siam.jpg" alt="photo" className="w-[70%] rounded-2xl hover:scale-102 hover:rotate-15 md:hover:scale-105 md:hover:rotate-30 transition duration-300 ease " />
            </div>
        </div>
    </>
}
